    ...
    $.Common.prototype = {
        ...
        headerResize: function() {
            ...
            if (self.windowWidth >= 768) {
                self.window.scroll(function() {
                    self.elements.header.toggleClass('reduced', $(document).scrollTop() >= self.windowHeight - 50);
                    self.elements.backTop.toggleClass('is-visible', $(document).scrollTop() >= self.windowHeight - 50);
                });
            }
        },
        ...
        sideMenus: function() {
            ...
            function openSideMenu() {
                ...
                self.elements.overlay.fadeToggle('fast', 'swing').css('display', 'block').on('click', function() {
        ...
        parallaxBackground: function() {
            ...
            self.window.scroll(function() {
                if (self.windowWidth >= 768) {
                    ...
                    self.elements.parallaxedBackground.css('background-position', 'center ' + (top / -3) + 'px');
        ...
        leafletMap: function() {
            ...
            L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={accessToken}', {
                ...
                accessToken: 'pk.eyJ1Ijoib2xkc3VuZmx1c2giLCJhIjoiZTNjOWNhMjhlMmExYTdiNzMzOTNmODRhZjFiNmFmYjUifQ.ASWmDJD_WvO8tRkaWxW_Og',
